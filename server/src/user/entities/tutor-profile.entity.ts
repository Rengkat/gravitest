...
// import type { TutorSession } from './tutor-session.entity';
// import type { TutorReview } from './tutor-review.entity';
// import type { TutorAvailability } from './tutor-availability.entity';
...
export class TutorProfile {
  ...
  // @OneToMany('Payout', (p: Payout) => p.tutor)
  // payouts: Payout[];
