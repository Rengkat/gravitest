  ...
  return [
    {
      id: "a1",
      action: "login",
      description: "Logged in from Lagos",
      timestamp: "2025-05-27T14:22:00Z",
    ...
    },
    {
      ...
      description: "Completed WAEC Chemistry Mock — Score: 82%",
      timestamp: "2025-05-27T13:05:00Z",
      device: "Chrome / Android",
    },
    {
      id: "a3",
      action: "content_accessed",
      description: 'Opened ebook: "WAEC Maths Past Questions 2010–2023"',
      timestamp: "2025-05-26T18:44:00Z",
    },
    {
      id: "a4",
    ...
    },
    {
      id: "a8",
      action: "quiz_completed",
      description: "Completed JAMB CBT Practice — Score: 67%",
    ...
    },
    {
      id: "a9",
      action: "login",
      description: "Logged in from Abuja",
      timestamp: "2025-04-15T08:00:00Z",
      ipAddress: "105.112.22.44",
      device: "Safari / iOS",
    },
    {
      id: "a10",
...
export function mockPayments(): PaymentRecord[] {
  return [
    ...
    },
    {
      ...
      status: "failed",
      channel: "Flutterwave",
      reference: "FLW-20250320-EF789",
      date: "2025-03-20T10:00:00Z",
    },
    {
      id: "p4",
      amount: 8_000,
      plan: "Pro Monthly (Promo)",
      status: "successful",
      channel: "Bank",
      reference: "BNK-20250220-GH012",
