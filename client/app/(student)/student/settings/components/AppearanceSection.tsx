...
import { SettingsCard, ToggleRow, ChipGroup, SettingsGroupLabel, SaveBar } from "./ui";
...
export default function AppearanceSection({ settings, onChange }: AppearanceSectionProps) {
  ...
  return (
    <div className="space-y-5">
      {/* Theme */}
      <SettingsCard title="Theme" description="Choose how Gravitest looks on your device">
        ...
        <p className="text-[11px] text-gray-400 mt-3">
          Note: Dark mode is coming soon. System theme follows your OS preference.
        </p>
      </SettingsCard>

      {/* Accent color */}
      <SettingsCard title="Accent Colour" description="Personalise your dashboard highlight colour">
      ...
      {/* Font size */}
      <SettingsCard title="Font Size" description="Adjust the text size across the app">
        <ChipGroup<FontSize>
        ...
        <div className={`mt-4 p-3.5 bg-gray-50 rounded-xl border border-gray-100`}>
          <p
            ...
            Preview: "The best preparation for tomorrow is doing your best today."
          </p>
        </div>
      </SettingsCard>
      ...
      <SettingsCard
        ...
        description="Control the spacing density of the dashboard">
        <div className="grid grid-cols-3 gap-3">
      ...
      <SettingsCard title="Display Options">
        <ToggleRow
          ...
          description="Enable transitions and micro-animations throughout the app"
        ...
        <ToggleRow
          ...
          description="Start with the dashboard sidebar minimised"
